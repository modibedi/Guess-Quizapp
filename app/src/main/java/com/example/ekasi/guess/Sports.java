...
public class Sports extends AppCompatActivity {
    ...
    public void submit(View view) {
        ...
        Intent stuff = new Intent(Sports.this, SportsResults.class);
